...
class TreeTopology(Topo):
    def build(self, brokernum, pubnum, subnum):
        ...
        for i in range(5):
            ...
            if i >= 1:
                self.addLink(self.mswitches[0], self.mswitches[i], bandwidth=10000, max_queue_size=10000, use_htb=True,
                             delay='0ms', loss=0)
        ...
        for i in range(3):
            ...
            self.addLink(self.brokerHosts[i], self.mswitches[1], bandwidth=10000, max_queue_size=10000, use_htb=True,
                         delay='0ms', loss=0)
            self.addLink(self.brokerHosts[i], self.mswitches[4], bandwidth=10000, max_queue_size=10000, use_htb=True,
                         delay='0ms', loss=0)
        ...
        for i in range(pubnum):
            ...
            self.addLink(self.pubHosts[i], self.mswitches[2], bandwidth=10000, max_queue_size=10000, use_htb=True,
                         delay='0ms', loss=0)
        ...
        for i in range(subnum):
            ...
            self.addLink(self.subHosts[i], self.mswitches[3], bandwidth=10000, max_queue_size=10000, use_htb=True,
                         delay='0ms', loss=0)
