...
class BusTopology(Topo):
    def build(self, brokernum=3, pubnum=3, subnum=5):
        self.pubHosts = []
        self.subHosts = []
        self.brokerHosts = []
        self.mswitches = []
        ...
        for i in range(pubnum):
            ...
            self.addLink(self.pubHosts[i], self.mswitches[0], bandwidth=10000, max_queue_size=10000, use_htb=True,
                         delay='0ms', loss=0)
        ...
        for i in range(subnum):
            ...
            self.addLink(self.subHosts[i], self.mswitches[2], bandwidth=10000, max_queue_size=10000, use_htb=True,
                         delay='0ms', loss=0)
