...
def parseCmdLineArgs ():
    ...
    parser.add_argument("-b", "--broker", type=int, default=9, help="Number of brokers, default 9")
...
def main():
    ...
    if topo_choice == 1:
        ...
        topo = BusTopology(brokernum=broker_num, pubnum=pub_num, subnum=sub_num)
        mainHelper(topo)
    ...
    # Star Topology
        ...
        # instantiate our topology
        print('Instantiate topology')
        topo = StarTopology(brokernum=broker_num, pubnum=pub_num, subnum=sub_num)
        mainHelper(topo)
    ...
    # Tree Topology
        ...
        # instantiate our topology
        print('Instantiate topology')
        topo = TreeTopology(brokernum=broker_num, pubnum=pub_num, subnum=sub_num)
        mainHelper(topo)
